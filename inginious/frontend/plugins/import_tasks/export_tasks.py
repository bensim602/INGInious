...
class ExportTasks(INGIniousAdminPage):
    """ Export tasks """
    ...
    def page(self, course, errors=None, validated=False):
        ...
        return self.template_helper.get_custom_renderer(
            'frontend/plugins/import_tasks').export_tasks(course, None, toc, course.get_tasks(), errors, validated)


class ExportTasksTemplate(INGIniousTemplateAdminPage, ExportTasks):
    """ Template equivalent """
