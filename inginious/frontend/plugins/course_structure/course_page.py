...
# [Source code integration]: Just add line 60 and add argument at line 90 to inginious.frontend.pages.course
...
class CoursePage(INGIniousAuthPage):
    ...
    def show_page(self, course):
        ...
        if not self.user_manager.course_is_open_to_user(course, lti=False):
            ...
            # [Source code integration]: Add to course page
            ...
            # [Source code integration]: Modify file to render and add toc to arguments
            return self.template_helper.get_custom_renderer('frontend/plugins/course_structure').course(user_info,
                                                                                                        course,
                                                                                                        last_submissions,
                                                                                                        tasks,
                                                                                                        course_structure,
