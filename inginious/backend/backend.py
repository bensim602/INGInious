...
class Backend(object):
    ...
    async def handle_client_get_queue(self, client_addr, _: ClientGetQueue):
        ...
        await ZMQUtils.send_with_addr(self._client_socket, client_addr, BackendGetQueue(jobs_running, jobs_waiting, self._registered_agents, self._available_agents))
